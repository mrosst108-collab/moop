...
Also preopened: the RME-7 slots (`docs/model.md`) — `port`, generated
by the world, and `jsharp`, `gsharp`, `gtildesharp`, `sigma`, `f`,
`kappa`, `gamma`, generated by `port`. They are ordinary protos that
host nothing; teach them to fill them. Names are rebindable as ever.
